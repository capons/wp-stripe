<style type="text/css">
    ...
    /*TOP AREA CSS STUFF*/
    .topArea {
    <?php if($results->lp_banner_bg_style == "hide" ){ echo "display: none;";} ?> background-color: <?php if($results->lp_banner_bg_color == ""){ echo "#FFF"; } else { echo $results->lp_banner_bg_color; } ?>;
    <?php
    ...
    .headlineArea {
        background-color: <?php if($results->lp_background_color == ""){ echo "#2F2F2F;"; } else { echo $results->lp_background_color; } ?>;
    <?php
