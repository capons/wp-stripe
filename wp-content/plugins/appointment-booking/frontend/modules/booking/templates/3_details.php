                ...
                <div class="ab-formField">
                    ...
                    <?php elseif ( $custom_field->type == 'checkboxes' ) : ?>
                        <?php foreach ( $custom_field->items as $item ) : ?>
                            <label>
                                <input type="checkbox" class="ab-custom-field" value="<?php echo esc_attr( $item['value'] ) ?>" name="ab-custom-field-<?php echo $custom_field->id ?>" <?php checked( @in_array( $item['value'], @$cf_data[ $custom_field->id ] ), true, true ) ?> />
                                <?php echo $item['label'] ?>
                            </label><br/>
                        <?php endforeach ?>
                    <?php elseif ( $custom_field->type == 'radio-buttons' ) : ?>
                        <?php foreach ( $custom_field->items as $item ) : ?>
                            <label>
                                <input type="radio" class="ab-custom-field" value="<?php echo esc_attr( $item['value'] ) ?>" name="ab-custom-field-<?php echo $custom_field->id ?>" <?php checked( $item['value'], @$cf_data[ $custom_field->id ], true ) ?> />
                                <?php echo $item['label'] ?>
                            </label><br/>
                        <?php endforeach ?>
