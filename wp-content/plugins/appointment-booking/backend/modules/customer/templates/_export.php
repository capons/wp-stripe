        ...
        <form class="form-horizontal" action="<?php echo admin_url( 'admin-ajax.php?action=ab_export_customers' ) ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="checkbox"> <label> <input checked value="<?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_name' ) ?>" name="exp[name]" type="checkbox"> <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_name' ) ?> </label> </div>
                    ...
                    <div class="checkbox"> <label> <input checked value="<?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_phone' ) ?>" name="exp[phone]" type="checkbox"> <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_phone' ) ?> </label> </div>
                    <div class="checkbox"> <label> <input checked value="<?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_email' ) ?>" name="exp[email]" type="checkbox"> <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_email' ) ?> </label> </div>
