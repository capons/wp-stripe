            ...
            <table>
                <thead class="ab-desktop-version">
                    <tr>
                        ...
                        <th data-default="<?php echo esc_attr( get_option( 'ab_appearance_text_label_employee' ) ) ?>" class="ab-employee-list"><?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_employee' ) ?></th>
                ...
                <tbody class="ab-desktop-version">
                    <tr>
                        ...
                        <td><?php echo AB_DateTimeUtils::formatDate( strtotime( '+2 days' ) ) ?></td>
                        <td><?php echo AB_DateTimeUtils::formatTime( 28800 ) ?></td>
                        <td>Nick Knight</td>
                        <td><?php echo AB_Utils::formatPrice( 350 ) ?></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><?php echo AB_DateTimeUtils::formatDate( strtotime( '+3 days' ) ) ?></td>
                        <td><?php echo AB_DateTimeUtils::formatTime( 57600 ) ?></td>
                        <td>Wayne Turner</td>
                        <td><?php echo AB_Utils::formatPrice( 400 ) ?></td>
                        <td>
                            <span title="<?php esc_attr_e( 'Edit', 'bookly' ) ?>" class="ab--actions" data-action="edit"></span>
                            <span title="<?php esc_attr_e( 'Remove', 'bookly' ) ?>" class="ab--actions" data-action="drop"></span>
                        </td>
                ...
                <tbody class="ab-mobile-version">
                    <tr>
                        <th data-default="<?php echo esc_attr( get_option( 'ab_appearance_text_label_service' ) ) ?>" class="ab-service-list"><?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_service' ) ?></th>
                        <td>Crown and Bridge</td>
                    </tr>
                    <tr>
                        <th><?php _e( 'Date', 'bookly' ) ?></th>
                ...
                <tfoot class="ab-desktop-version">
                    <tr>
                        ...
                        <td><strong class="ab-total-price"><?php echo AB_Utils::formatPrice( 750 ) ?></strong></td>
                        <td></td>
                    </tr>
                </tfoot>
